function [h_main, h_inset,new_fig]=inset2(main_handle, inset_handle,inset_handle2, inset_size)
...
inset_fig2 = findobj(inset_handle2,'Type','axes');
h_inset2 = copyobj(inset_fig2,new_fig);

ax=get(main_fig,'Position');


set(h_inset2,'Position', [.7*ax(1)+ax(3)-inset_size .5*ax(2)+ax(4)-inset_size inset_size inset_size])

set(h_inset,'Position', [ax(1)+0.4*ax(3)-inset_size .5*ax(2)+ax(4)-inset_size inset_size inset_size])   
